...
Slightly modified version of https://github.com/cristalhq/jwt removing unnecessary parts.
...
There are many JWT libraries, but many of them are hard to use (unclear or fixed API), not optimal (unneeded
allocations + strange API). This library addresses all these issues. It's simple to read, to use, memory and CPU
conservative.
